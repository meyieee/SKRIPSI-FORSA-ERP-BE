/**
 * Accommodation Request Repository
 */
...
const REQUEST_TYPE = 'accommodation-request';
...
function transformToBackend(frontendData) {
  return transformAccommodationRequestToBackend({
    ...frontendData,
...
function transformToFrontend(backendData) {
  return transformAccommodationRequestToFrontend(backendData);
}

/**
 * Generate reference request number untuk accommodation request
...
async function getById(id) {
  ...
  // Validate it's an accommodation request
...
/**
 * Get Accommodation Request by ref_request_no
...
/**
 * Get Accommodation Request Draft
