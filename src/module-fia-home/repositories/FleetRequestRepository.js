...
const REQUEST_TYPE = 'fleet-request';
...
function transformToBackend(frontendData) {
  return transformFleetRequestToBackend({
    ...frontendData,
...
function transformToFrontend(backendData) {
  return transformFleetRequestToFrontend(backendData);
}

/**
 * Generate reference request number untuk fleet request
...
/**
 * Get Fleet Request by ref_request_no
