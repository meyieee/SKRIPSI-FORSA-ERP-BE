...
const REQUEST_TYPE = 'job-request';
...
function transformToBackend(frontendData) {
  return transformJobRequestToBackend({
    ...frontendData,
...
function transformToFrontend(backendData) {
  return transformJobRequestToFrontend(backendData);
}

/**
 * Generate reference request number untuk job request
...
/**
 * Get Job Request by ref_request_no
