...
const REQUEST_TYPE = 'cash-request';
...
function transformToBackend(frontendData) {
  return transformCashRequestToBackend({
    ...frontendData,
...
function transformToFrontend(backendData) {
  return transformCashRequestToFrontend(backendData);
}

/**
 * Generate reference request number untuk cash request
...
/**
 * Get Cash Request by ref_request_no
