...
const REQUEST_TYPE = 'transport-request';
...
function transformToBackend(frontendData) {
  return transformTransportRequestToBackend({
    ...frontendData,
...
function transformToFrontend(backendData) {
  return transformTransportRequestToFrontend(backendData);
}

/**
 * Generate reference request number untuk transport request
...
async function getById(id) {
  ...
  // Validate it's a transport request
...
/**
 * Get Transport Request by ref_request_no
