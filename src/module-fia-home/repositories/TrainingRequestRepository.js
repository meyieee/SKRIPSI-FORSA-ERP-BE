...
const REQUEST_TYPE = 'training-request';
...
function transformToBackend(frontendData) {
  return transformTrainingRequestToBackend({
    ...frontendData,
...
function transformToFrontend(backendData) {
  return transformTrainingRequestToFrontend(backendData);
}

/**
 * Generate reference request number untuk training request
...
async function getById(id) {
  ...
  // Validate it's a training request
...
/**
 * Get Training Request by ref_request_no
...
async function update(frontendData, id) {
  // Check if record exists and is training request
