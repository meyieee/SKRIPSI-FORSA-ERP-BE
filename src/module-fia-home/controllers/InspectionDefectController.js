 ...
 */
const saveInspectionDefectDraft = async (req, res) => {
  try {
    const responseData = await InspectionDefectRepository.saveDraft(req.body);
 ...
 */
const getInspectionDefectDraft = async (req, res) => {
  try {
    ...
    const draft = await InspectionDefectRepository.getDraft(request_by);
