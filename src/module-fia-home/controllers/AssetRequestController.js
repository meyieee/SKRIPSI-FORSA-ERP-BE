...
/**
 * POST /api/asset-request/draft
 * Save Asset Request as Draft
 */
const saveAssetRequestDraft = async (req, res) => {
  try {
    const responseData = await AssetRequestRepository.saveDraft(req.body);
 ...
 */
const getAssetRequestDraft = async (req, res) => {
  try {
    ...
    const draft = await AssetRequestRepository.getDraft(request_by);
